...
def cs():
    ...
    print("Executing critical section of Node6")
    time.sleep(15)
    print("Exiting critical section of Node6")

    # Broadcasting Release

    Request_Queue.get()
    Clock += 1
    msg = str(Clock) + " Node6 Release"
