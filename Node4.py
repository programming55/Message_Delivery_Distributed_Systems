...
def node_recv(conn,rip,rport):
    ...
    if(Type_of_Message == 'Request'):
        ...
        send(Id, msg, mode)
        print("Node4 Sending Reply message to ", Id)
...
def cs():
    ...
    print("Requesting CS for Node4")
    Request_Queue.put((Clock, "Node4"))
    driver.Request_Clock_Queue.put((Clock, "Node4"))
    driver.Request_Clock_List.append((Clock, "Node4"))
    ...
    print("executing CS Node4")
    
    driver.Execution_List.append("Executing critical section of Node4")

    time.sleep(10)

    driver.Execution_List.append("Exiting critical section of Node4")
    print("Finished with CS Node4")
    ...
    Clock += 1
    MSG_ID += 1
    print("Sending release msg Node4")
