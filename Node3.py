...
ip_addr = "127.0.0.1"
Nodes = ["Node3", "Node2", "Node3", "Node4", "Node5", "Node6", "Node7"]
...
def cs():
    ...
    driver.Append_Request_Clock_List((Clock, "Node3"))
    driver.Push_Request_Clock_Queue((Clock, "Node3"))
    MSG_ID += 1
    ...
    driver.Append_Execution_List("Executing critical section of Node3")
    # print("Executing critical section of Node2")
    time.sleep(10)
    driver.Append_Execution_List("Exiting critical section of Node3")
